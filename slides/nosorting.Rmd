...
* Clean up the `fwdpp` PR.  This could actually take a few weeks, depending on whether I try to write tests
  that don't depend on simulations. In any case, there's a lot of integer cast warnings to sanitize,
  and lots of `D.R.Y.` issues to turn into functions.
